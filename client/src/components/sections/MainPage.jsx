                    ...
                    <div className="w-full min-w-screen min-h-screen pt-14">
                        ...
                        bg-cover bg-center text-white flex flex-col justify-center items-start px-8 py-16 sm:px-16 sm:py-32 w-full transition-all duration-1000 relative group`}
                                    ...
                                    {events.length > 1 && (
                                        <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 flex items-center space-x-4">
                                            <button
                                                ...
                                                className={`${currentEventIndex === 0 ? 'opacity-50' : 'opacity-100 cursor-pointer'
                                                    }`}
                                            >
                                            ...
                                            <button
                                                ...
                                                className={`${currentEventIndex === events.length - 1 ? 'opacity-50' : 'opacity-100 cursor-pointer'
                                                    }`}
                                            >
                            ...
                            {announcements.length > 0 ? (
                                <div
                                    className={`grid grid-rows-2 w-full ${events.length === 0 ? 'col-span-1 sm:col-span-3' : 'col-span-1'
                                        }`}
                                >
