...
export default function GuestViewJobDetails() {
        ...
        return (
            <>
                ...
                <div className={`transition-all duration-300 ${sidebarOpen ? "ml-64" : "ml-0"}`}>
                    <div className="w-screen pt-12 min-h-screen flex items-center justify-center">
                        <div className="text-center">
                            <h2 className="text-2xl font-bold text-gray-800 mb-4">Job not found</h2>
                            <button 
                                onClick={() => navigate(-1)}
                                className="bg-[#104C96] text-white px-6 py-2 rounded-md hover:bg-[#105596] transition-colors"
                            >
                                Go Back
                            </button>
                        </div>
    ...
    return (
        ...
        <div>
            <div className="w-full h-full min-w-screen min-h-screen pt-12">
                <div
                ...
                >
                    ...
                    <div className="relative z-10">
                        ...
                        <p className="text-2xl sm:text-3xl font-bold flex items-center gap-3 text-left">
                ...
                <div className="bg-white px-10 py-14 space-y-6 pr-15">
