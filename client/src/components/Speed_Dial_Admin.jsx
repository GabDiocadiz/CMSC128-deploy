...
export default function Speed_Dial_Admin({}){
    return(
...
<div data-dial-init class="fixed end-6 bottom-6 group">
    <div id="speed-dial-menu-default" class="flex-col items-center opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 mb-4 space-y-2">
        ...
        <button type="button" data-tooltip-target="tooltip-preview" data-tooltip-placement="left" class="flex justify-center items-center w-[52px] h-[52px] text-white hover:text-white bg-[#891839] rounded-full border border-[#891839] shadow-xs hover:bg-[#a41c4d] focus:ring-4 focus:ring-[#891839] focus:outline-none group">
        ...
        <button type="button" data-tooltip-target="tooltip-share" data-tooltip-placement="left" class="flex justify-center items-center w-[52px] h-[52px] text-white hover:text-white bg-[#891839] rounded-full border border-[#891839] shadow-xs hover:bg-[#a41c4d] focus:ring-4 focus:ring-[#891839] focus:outline-none">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
