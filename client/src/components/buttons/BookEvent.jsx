...
export default function BookEventButton() {
    return (
        ...
        <button className="relative z-10 bg-[#891839] group-hover:bg-[#145C44] text-white rounded-3xl border-5 border-white w-full h-full flex items-center justify-center px-10 py-6 transition-colors duration-300 cursor-pointer">
